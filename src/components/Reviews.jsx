...
const reviews = [
  {
    ...
    text: "Выражаю искреннюю признательность за консультации и оформление документов.",
    image: "/1м.png",
  },
  {
    id: 2,
    name: "Игорь Барташов",
    text: "Сделали по моей готовой записи документы и переводы за 2 часа. Обратился, приехал в офис, сделали и поехал сразу подаваться! Профессионализм!",
    image: "/2м.png",
  },
  {
    id: 3,
    name: "Дмитрий Вольский",
    text: "Визу получил, 3 месяца. Думал вообще неделя будет, никогда не открывал визы. Спасибо!",
    image: "/3м.png",
  },
  {
    id: 4,
    name: "Аганова Марина",
    text: "Благодарю менеджеров за профессиональную консультацию по моей нестандартной ситуации. Приехала в Литву в срок, не подвели.",
    image: "/4м.png",
  },
  {
    id: 5,
    name: "Ирина Васкина",
    text: "Открыли польскую туристическую визу на 2 года!! Обращаюсь в третий раз в компанию. И сестра моя там делала испанскую визу. Мужу сделали рабочую. Искренне благодарю директора, знакомы лично уже, менеджеров, рекомендую всем своим знакомым.",
    image: "/5м_1.png",
  },
];
...
const Reviews = () => {
  ...
  const swipeHandlers = useSwipeable({
    ...
    trackMouse: true, // Поддержка мыши
  });
