...
const reviews = [
  {
    ...
    text: "Выражаю искреннюю признательность за консультации и помощь в сборе пакета документов.",
    image: "/1м.png",
  },
  {
    id: 2,
    name: "Игорь Барташов",
    text: "Помогли со сбором и подготовкой документов за 2 часа. Обратился, приехал в офис, сделали! Профессионализм!",
    image: "/2м.png",
  },
  {
    id: 3,
  ...
  },
  {
    id: 5,
    name: "Ирина Васкина",
    text: "Помогли с подготовкой необходимого пакета документов! Обращаюсь в третий раз в компанию. И сестра моя обращалась, и муж. Искренне благодарю директора, знакомы лично уже, менеджеров, рекомендую всем своим знакомым.",
    image: "/5м_1.png",
  },
];
